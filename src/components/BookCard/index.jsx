...
function BookCard() {
  ...
  let products = [
    ...
    {id:2, img: img2, price: "670 сом", name: "Футболка оверсайз / универсал" },
